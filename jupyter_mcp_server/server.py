...
async def assign_kernel_to_notebook(
    ...
    session_name: Annotated[Optional[str], Field(description="Optional name for the session (defaults to notebook path)")] = None,
...
async def use_notebook(
    ...
    notebook_path: Annotated[Optional[str], Field(description="Path to the notebook file, relative to the Jupyter server root (e.g. 'notebook.ipynb'). If not provided, switches to an already-connected notebook with the given name.")] = None,
    ...
    kernel_id: Annotated[Optional[str], Field(description="Specific kernel ID to use (optional, will create new if not provided)")] = None,
