...
Run it yourself, or use the [hosted endpoint](/hosted) when your notebook needs to stay
alive, reach managed data and compute, or be securely available to several agents.
:::info
