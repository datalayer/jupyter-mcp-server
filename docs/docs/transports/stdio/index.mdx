...
For advanced configurations with separate document storage and code sandbox execution, see the [complete configuration examples](/reference/configuration#configuration-examples).
