...
You can create custom handlers for logging, metrics, auditing, or any other purpose. A hook *observes* calls; to add, replace or wrap a tool, write an [extension](/operations/extensions) instead.
