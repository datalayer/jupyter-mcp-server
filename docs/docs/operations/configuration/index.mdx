...
| `SANDBOX_GPU` | GPU flavor / accelerator for supported variants. Modal/Datalayer examples: `T4`, `A10G`, `A100`, `H100`. Daytona examples: `H100`, `H200`, `RTX-4090`. CoreWeave example: `H100`. Kaggle batch examples: `NvidiaTeslaT4`, `NvidiaTeslaP100` (aliases `T4`, `P100` also supported). | `T4` | `None` |
