...
- Configuration change, see details in the [MCP guide](https://datalayer.ai/docs/access-mcp#configure-your-client) and [server configuration](/features/configuration).
