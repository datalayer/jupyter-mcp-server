...
- Supported: `Claude desktop`, `Claude Code`, `Gemini CLI`
...
This prompt allows users to cite specific cells in a notebook, enabling users to have the specified LLM perform precise subsequent operations on them.
