...
The server currently offers 22 tools organized into 3 categories:

## Server and Runtime Management (7 tools)
...
- If `use_sandbox` has selected an active sandbox, execution is routed to that sandbox instead.
