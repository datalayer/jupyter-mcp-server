...
- Input:
  ...
  - `start_index`(int, optional): Starting index for pagination (default: 25)
  - `limit`(int, optional): Maximum number of items to return (0 means no limit) (default: 25)
  - `pattern`(string, optional): Regex pattern to filter file paths (default: "")
