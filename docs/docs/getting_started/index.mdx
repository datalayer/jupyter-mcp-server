...
- **Jupyter Code Sandbox** - It can connect to [**Jupyter Server**](/code-sandboxes/jupyter-server) (local or remote), [**JupyterHub**](/code-sandboxes/jupyterhub), [**Datalayer**](/code-sandboxes/datalayer), [**Kaggle**](/code-sandboxes/kaggle), [**Monty**](/code-sandboxes/monty), [**Google Colab**](/code-sandboxes/google-colab), [**Modal**](/code-sandboxes/modal), [**Daytona**](/code-sandboxes/daytona), [**E2B**](/code-sandboxes/e2b), [**CoreWeave**](/code-sandboxes/coreweave), and [**Cloudflare**](/code-sandboxes/cloudflare).
...
You can customize the setup further based on your requirements. Refer to the [server configuration](/operations/configuration) for more details on the possible configurations.
...
If you're deploying for multiple users, see the [Multi-User Documentation](/security/multi-users) for architecture patterns and best practices.
:::
...
Run code in Daytona cloud sandboxes, with GPU and preemptible GPU capacity.

👉 [Daytona Documentation](/code-sandboxes/daytona)

### E2B

Run code in E2B sandboxes, where each context is a Jupyter kernel and rich outputs come back as results.

👉 [E2B Documentation](/code-sandboxes/e2b)

### CoreWeave

Run code in CoreWeave sandboxes, containers on CoreWeave's GPU cloud.

👉 [CoreWeave Documentation](/code-sandboxes/coreweave)

### Cloudflare

Run code in Cloudflare sandboxes, reached through the sandbox bridge Worker.

👉 [Cloudflare Documentation](/code-sandboxes/cloudflare)

## MCP Client Configuration

Once you've set up your MCP server, you need to configure your MCP client. Choose your client:

- [Claude Desktop](https://datalayer.ai/docs/mcp-clients/claude-desktop) - Anthropic's desktop app
- [VS Code](https://datalayer.ai/docs/mcp-clients/vscode) - GitHub Copilot integration
- [Cursor](https://datalayer.ai/docs/mcp-clients/cursor) - AI-first code editor
- [Cline](https://datalayer.ai/docs/mcp-clients/cline) - VS Code extension
- [Windsurf](https://datalayer.ai/docs/mcp-clients/windsurf) - Collaborative coding environment
...
📝 **Use Prompts** - Discover [prompt features](/operations/prompts) for citing and referencing notebooks

🔒 **Secure Your Deployment** - Review [authentication and security best practices](/security/authentication) for token management and authentication

📚 **Learn More** - Check out the [Resources](/resources) section for tutorials, videos, and community content

## Additional Resources

- [Configuration Reference](/operations/configuration) - Complete environment variable and CLI option documentation
