...
You can customize the setup further based on your requirements. Refer to the [server configuration](/management/configuration) for more details on the possible configurations.
...
📝 **Use Prompts** - Discover [prompt features](/management/prompts) for citing and referencing notebooks
...
- [Configuration Reference](/management/configuration) - Complete environment variable and CLI option documentation
