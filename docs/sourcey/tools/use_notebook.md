...
Registered by the `@mcp.tool` decorator at [`jupyter_mcp_server/server.py:402`](https://github.com/datalayer/jupyter-mcp-server/blob/c132b061240dbe53d83290bff3007f43fc01ea6b/jupyter_mcp_server/server.py#L402) (commit `c132b061240d`).
